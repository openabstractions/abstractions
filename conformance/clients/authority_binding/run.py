...
with tempfile.TemporaryDirectory(prefix='authority-binding-',dir=base) as temp:
 ...
 run([a.cmake,'-S',source,'-B',b/'sdk','-DABSTRACTION_FACADE_BUILD_AGGREGATE=OFF','-DABSTRACTION_FACADE_BUILD_ASKS=ON','-DABSTRACTION_FACADE_BUILD_RIGHTS=ON','-DABSTRACTION_FACADE_BUILD_STORAGE=ON','-DBUILD_SHARED_LIBS=OFF','-DABSTRACTION_IPC_BUILD_TESTS=OFF'])
